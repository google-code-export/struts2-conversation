...
/**
 * A simple abstract adapter used to adapt frameworks to the session management
 * components. Makes use of {@link ThreadLocal} to make the current request's
 * adapter available through the static call
...
public abstract class SessionAdapter implements Serializable {
	 ...
	 * {@link DefaultSessionConfigurationProvider} is the name of the controller
	...
	/**
	 * Add a {@link SessionPostProcessor} that is guaranteed to be executed
	 * after action execution. Calling
	 * {@link SessionPostProcessor#postProcessSession(SessionAdapter)} is the
	 * responsibility of the concrete SessionAdapter extending class.
	 * 
	...
	/**
	 * Get the {@link ThreadLocal} SessionAdapter associated with the current
	 * request
	 * 
	 * @return
	 */
