...
/**
 * This class listens for the destruction of sessions and cleans up that
 * sessions conversation resources. With Servlet API 3.0+, this class is
 * auto-discovered using the {@link WebListener} annotation. In earlier API
 * versions, it must be configured in the web.xml (or not at all if cleanup is
 * not a concern).
 * 
 * @author rees.byars
 */
