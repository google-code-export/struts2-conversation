...
/**
 * 
 * A utility class that provides static methods that are used internally and for
 * unit testing. Use outside of these contexts should come only as a last
 * resort.
 * 
 * @author rees.byars
 * 
...
public class SessionUtil {
	...
	/**
	 * Given a session field's name and an instance, the value is set for the
	 ...
	 * caching is performed, for use only in unit testing.
	 * 
	 * @param target
	 */
	 ...
	 * {@link SessionField} are injected from the session. No caching is
	 * performed, for use only in unit testing.
	 * 
	 * @param target
	 */
