...
public class StrutsScopeConstants {
	...
	public static final String CONVERSATION_ADAPTER_FACTORY_KEY = "struts.conversation.adapterFactory";
	public static final String SESSION_MANAGER_KEY = "struts.scope.sessionManager";
